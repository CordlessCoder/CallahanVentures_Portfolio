...
def get_first_operator(query_string):
    try:
        parts = query_string.split()

        for part in parts:
            if any(operator in part for operator in ["inurl:", "intext:", "ext:", "intitle:", "site:", "numrange:", "after:", "before:"]):
                return part
